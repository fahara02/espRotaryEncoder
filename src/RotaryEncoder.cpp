...
void Encoder::begin() {
  ...
  xTaskCreatePinnedToCore(EncoderMonitorTask, "EncoderMonitor",
                          EncoderTaskStack, this, EncoderTask_Priority,
                          &encoderTaskHandle, EncoderTask_CORE);

  if (buttonPin_ != GPIO_NUM_NC) {
    xTaskCreatePinnedToCore(ButtonMonitorTask, "ButtonMonitor", BtnTaskStack,
                            this, BtnTask_Priority, &buttonTaskHandle,
                            BtnTask_CORE);
  }
